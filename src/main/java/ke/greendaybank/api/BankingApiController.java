...
public class BankingApiController {
    ...
    public record CreditRequest(@NotBlank String accountNumber, @DecimalMin(value = "0.01") BigDecimal amount, @NotBlank String narration, String idempotencyKey, String actor) {}
    public record MovementRequest(@NotBlank String fromAccountNumber, @NotBlank String toAccountNumber, @DecimalMin(value = "0.01") BigDecimal amount, @NotBlank String narration, String idempotencyKey, String actor) {}
